        ...
        <div className="flex shrink-0 items-center gap-2.5 xs:pb-4 xs:pt-8 md:flex-nowrap md:gap-3.5 lg:gap-4">
          {!isFreeItem ? (
            <AddToCart
              ...
              className="w-full flex-1 shrink-0 rounded border border-light-200 bg-black text-brand hover:bg-transparent hover:text-light-200 dark:border-dark-600 dark:bg-dark-250 dark:text-brand dark:hover:text-brand-dark"
            />
          ) : (
            <FreeDownloadButton
              productId={id}
